...
import { CreateReferrerModal, FeedbackResultModal } from "./components";
    ...
    <ReferrerContainer>
      ...
      <Container>
        <div className="referrer_action">
          ...
          <Button className="action" onClick={openCreateReferrerModal}>
            ارجاع جدید
          </Button>
        </div>
        <Table
      ...
      {isOpenCreateReferrer && (
        <CreateReferrerModal
          onClose={closeCreateReferrerModal}
...
export default CrmReferrerPage;
