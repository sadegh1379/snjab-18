...
import { RewardBaseFormContainer } from "../css/reward-base-form";
import { ISuggestionReportFormValues } from "../types";

interface IRewardBaseFormProps {
...
const RewardBaseForm: FC<IRewardBaseFormProps> = ({
  formValues,
  onChangeForm,
}) => {
  return (
    <RewardBaseFormContainer>
      <Input
